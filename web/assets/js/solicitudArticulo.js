...
function creaSolicitud() {
    ...
    $.ajax({type: "POST",
        ...
        success: termine,
        error: function (jqXHR) {
            swal("Error!", "Seleccione los artículos que requiere antes de enviar la solicitud", "warning");
        }
    });
}
...
function afterUpdateApE() {
    ...
    //prueba 
  swal("Solicitud aprobada..!", "Correctamente!!", "success");
...
function actualizarEstadoJefe() {
    ...
    $.ajax({type: "PUT",
        ...
        error: function (jqXHR) {
           swal("Error!", "no se pudo solicitar visto bueno jefe", "warning");
        }
    });
...
function actualizarEstadoTI() {
    ...
    $.ajax({type: "PUT",
        ...
        error: function (jqXHR) {
             swal("Error!", "no se pudo solicitar visto bueno TI", "warning");
        }
    });

}

//despues de actualizar el estado se oculta el modal correspondiente
...
function actualizarEstadoRechazo() {
    ...
    $.ajax({type: "PUT",
        ...
        error: function (jqXHR) {
            swal("Error!", "no se pudo rechazar la solicitud", "warning");
        }
    });
...
function afterUpdateApEs() {
    buscarSolicitudxAprobar();
    swal("Solicitud rechazada..!", "Correctamente!!", "success");
    $('#Rechazar').modal('hide');
...
function actualizarEstadoVbJf() {
    ...
    $.ajax({type: "PUT",
        ...
        error: function (jqXHR) {
             swal("Error!", "no se pudo aprobar la solicitud", "error");
        }
    });
...
function afterUpdateRechJefe() {
    ...
    $('#Rechazar').modal('hide');
    swal("Solicitud ha sido rechazada..!", "Error!!", "error");
