<%-- 
    Document   : reporteConsumo
    Created on : 17/03/2020, 05:35:07 PM
    Author     : oscar
--%>
        ...
        <div class="card" id="cuerpoListaOrdenes">
            <div class="card-body">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <form id="existencias" action="javascript:getReporte()" >
                                <div>
...
<script>
    document.getElementById("ReportesMenu").style.color = "white";
    function logged() {
